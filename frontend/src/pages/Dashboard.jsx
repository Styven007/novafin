            ...
            >
              ...
              <span>Registrar Gasto</span>
                ...
                <button 
                  ...
                  className="flex items-center justify-center space-x-3 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-semibold py-4 px-6 rounded-xl transition transform hover:scale-105"
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button 
                  ...
                  className="flex items-center justify-center space-x-3 bg-purple-50 hover:bg-purple-100 text-purple-700 font-semibold py-4 px-6 rounded-xl transition transform hover:scale-105"
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
